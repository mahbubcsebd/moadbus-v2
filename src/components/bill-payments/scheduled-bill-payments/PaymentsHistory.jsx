import { scheduledBillPaymentHistory } from '@/api/endpoints';
import { motion } from 'framer-motion';
import { ChevronRight } from 'lucide-react';
import { useEffect, useState } from 'react';

const PaymentsHistory = ({ onClose, paymentData }) => {
  ...
  const getPaymentHistory = async () => {
    try {
      let payload = { scheduleId: paymentData.code };
      let result = await scheduledBillPaymentHistory(payload);
