        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            <h2 className="flex items-center gap-3 mb-6 text-2xl font-bold text-gray-900">
              <Monitor className="text-primary w-7 h-7" />
              Technical Requirements
            </h2>
            ...
            <div className="mb-6">
              ...
              <ul className="ml-8 space-y-2 text-gray-700 list-disc list-inside">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Supported Mobile Browsers</h3>
              </div>
              <ul className="ml-8 space-y-2 text-gray-700 list-disc list-inside">
                <li>Chrome browser on Android 9.0 and above, tablets and smartphones</li>
            ...
            {/* Operating Systems */}
            <div className="mb-6">
              <h3 className="mb-4 text-xl font-semibold text-gray-900">Operating Systems</h3>
              <p className="ml-8 leading-relaxed text-gray-700">
                All operating systems with the supported web browsers
              </p>
            </div>

            {/* Mobile OS Compatibility */}
            <div className="p-6 border border-orange-200 rounded-lg bg-linear-to-r from-primary/5 to-blue-50">
              <h3 className="mb-4 text-xl font-semibold text-gray-900">
                Mobile OS Version Compatibility
              </h3>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="p-4 bg-white border border-gray-200 rounded-lg">
                  <p className="mb-2 font-semibold text-gray-900">Android</p>
                  <p className="text-gray-700">Android 9.0 and above</p>
                </div>
                <div className="p-4 bg-white border border-gray-200 rounded-lg">
                  <p className="mb-2 font-semibold text-gray-900">iOS</p>
                  <p className="text-gray-700">
                    iOS 15, 16 and 17
                    <span className="block mt-1 text-sm text-gray-500">(Supported by Apple)</span>
                  </p>
                </div>
              </div>
            </div>
